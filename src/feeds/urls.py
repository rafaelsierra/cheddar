...
urlpatterns = patterns('',
    ...
    url(r'^my/posts/read/$', UserPostList.as_view(), {'is_read':True}, name='post-list-read'),
    url(r'^my/posts/unread/$', UserPostList.as_view(), {'is_read':False}, name='post-list-unread'),
    url(r'^my/posts/starred/$', UserPostList.as_view(), {'is_starred':True}, name='post-list-starred'),
