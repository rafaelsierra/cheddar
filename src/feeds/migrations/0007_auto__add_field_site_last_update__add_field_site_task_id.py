...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Site.last_update'
        db.add_column(u'feeds_site', 'last_update',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 31, 0, 0)),
                      keep_default=False)

        # Adding field 'Site.task_id'
        db.add_column(u'feeds_site', 'task_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=36, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Site.last_update'
        db.delete_column(u'feeds_site', 'last_update')

        # Deleting field 'Site.task_id'
        db.delete_column(u'feeds_site', 'task_id')
